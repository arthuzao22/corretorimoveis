      ...
      <CardContent className="p-6">
        ...
        {activeTab === 'presets' && (
          <div className="space-y-4">
            <p className="text-sm text-muted-foreground">Escolha um tema pré-definido como ponto de partida</p>
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              {Object.values(landingThemePresets).map(preset => (
                ...
                >
                  ...
                  <h4 className="font-medium text-foreground text-sm">{preset.name}</h4>
                  <p className="text-xs text-muted-foreground mt-0.5">{preset.typography.headingFont}</p>
                </button>
              ))}
            </div>
          </div>
        ...
        {activeTab === 'colors' && (
          <div className="space-y-6">
            <p className="text-sm text-muted-foreground">Personalize as cores da sua landing page</p>
        ...
        {activeTab === 'typography' && (
          <div className="space-y-6">
            <p className="text-sm text-muted-foreground">Configure as fontes e pesos</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-2 bg-muted border border-input rounded-lg text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-ring"
                >
            ...
            {/* Preview */}
            <div 
              className="mt-6 p-6 rounded-xl border border-border"
        ...
        {activeTab === 'spacing' && (
          <div className="space-y-6">
            <p className="text-sm text-muted-foreground">Configure o espaçamento e layout</p>
    ...
    <div>
      ...
      <div className="flex items-center gap-2">
        ...
        <input
          ...
          value={value}
          onChange={(e) => onChange(e.target.value)}
          className="flex-1 px-3 py-2 bg-muted border border-input rounded-lg text-sm font-mono uppercase text-foreground focus:outline-none focus:ring-2 focus:ring-ring"
          maxLength={7}
        />
      </div>
    </div>
