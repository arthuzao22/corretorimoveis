    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative bg-gradient-to-br from-slate-900 via-indigo-900 to-slate-900 text-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-32 md:pt-28 md:pb-40">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-indigo-500/20 backdrop-blur-sm rounded-full text-indigo-200 text-sm font-medium mb-8 border border-indigo-400/20">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                href="/imoveis"
                className="group bg-white text-slate-900 px-8 py-4 rounded-xl hover:bg-slate-50 transition-all shadow-xl hover:shadow-2xl font-semibold text-lg flex items-center justify-center gap-3"
              >
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-20 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white rounded-2xl shadow-sm shadow-slate-100 p-8 text-center border border-slate-100 hover:shadow-md hover:border-slate-200 transition-all hover:-translate-y-1">
            <div className="inline-flex items-center justify-center w-16 h-16 bg-indigo-50 border border-indigo-100 rounded-2xl mb-4">
              <HomeIcon className="w-8 h-8 text-indigo-600" />
            </div>
            <h3 className="text-4xl font-bold text-slate-900 mb-1">{totalImoveis}+</h3>
            <p className="text-slate-500 font-medium">Imoveis Disponiveis</p>
          </div>
          <div className="bg-white rounded-2xl shadow-lg shadow-gray-200/50 p-8 text-center border border-gray-100 hover:shadow-xl transition-all hover:-translate-y-1">
            ...
            <h3 className="text-4xl font-bold text-slate-900 mb-1">{totalCorretores}+</h3>
            <p className="text-slate-500 font-medium">Corretores Parceiros</p>
          </div>
          <div className="bg-white rounded-2xl shadow-lg shadow-gray-200/50 p-8 text-center border border-gray-100 hover:shadow-xl transition-all hover:-translate-y-1">
            ...
            <p className="text-slate-500 font-medium">Satisfacao dos Clientes</p>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="group p-8 rounded-2xl bg-gradient-to-b from-indigo-50 to-white border border-indigo-100 hover:shadow-lg transition-all">
            ...
            <h3 className="text-xl font-bold text-slate-900 mb-3">Seguranca Total</h3>
          ...
          <div className="group p-8 rounded-2xl bg-gradient-to-b from-emerald-50 to-white border border-emerald-100 hover:shadow-lg transition-all">
            ...
            <h3 className="text-xl font-bold text-slate-900 mb-3">Rapido e Facil</h3>
            <p className="text-slate-500 leading-relaxed">
          ...
          <div className="group p-8 rounded-2xl bg-gradient-to-b from-amber-50 to-white border border-amber-100 hover:shadow-lg transition-all">
            ...
            <h3 className="text-xl font-bold text-slate-900 mb-3">Imoveis Selecionados</h3>
            <p className="text-slate-500 leading-relaxed">
      ...
      <section className="bg-slate-50 py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-12">
            ...
            <Link
              href="/imoveis"
              className="group inline-flex items-center gap-2 text-indigo-600 hover:text-indigo-700 font-semibold transition-colors"
            >
              Ver todos
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {imoveis.map((imovel: any) => (
                <Link key={imovel.id} href={`/imovel/${imovel.id}`}>
                  <div className="group bg-white rounded-2xl shadow-sm hover:shadow-md hover:border-slate-200 transition-all duration-300 overflow-hidden border border-slate-100 h-full flex flex-col">
                    {/* Image */}
          ...
          {imoveis.length > 0 && (
            <div className="text-center mt-12">
              <Link
                href="/imoveis"
                className="group inline-flex items-center gap-3 bg-indigo-600 text-white px-8 py-4 rounded-xl hover:bg-indigo-700 transition-all shadow-lg hover:shadow-xl font-semibold text-lg"
              >
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div className="text-center">
            <div className="relative inline-flex items-center justify-center w-20 h-20 bg-indigo-600 rounded-2xl mb-6">
              <span className="text-3xl font-bold text-white">1</span>
              <span className="absolute -top-2 -right-2 w-8 h-8 bg-indigo-100 text-indigo-600 rounded-full flex items-center justify-center text-sm font-bold">
                1
              </span>
            </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <Link
                href="/register"
                className="group inline-flex items-center gap-3 bg-white text-indigo-600 px-8 py-4 rounded-xl hover:bg-indigo-50 transition-all shadow-xl hover:shadow-2xl font-semibold text-lg"
              >
                <Users className="w-5 h-5" />
                Criar Conta Gratis
                <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-indigo-200 text-sm">CRM completo com pontuacao e tags</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-indigo-200 text-sm">Dashboard com analytics em tempo real</p>
                    </div>
                  </div>
                </div>
              </div>
